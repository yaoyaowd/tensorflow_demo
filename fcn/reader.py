...
Code from https://github.com/shekkizh/FCN.tensorflow/blob/master/BatchDatsetReader.py
"""
import numpy as np
...
class BatchReader:
    ...
    def _read_images(self, files):
        ...
        self.images = np.array([self._transform(filename['image']) for filename in files])
